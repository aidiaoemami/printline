    ...
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right">
                ...
                <li class="upper-links"><a class="links" href="<?php echo e(route('tokosaya')); ?>">Toko Saya</a></li>
                <li class="upper-links"><a href="<?php echo e(route('tambahlayanan')); ?>" class="links">Tambah Layanan</a>
                ...
                <li class="upper-links">
                    ...
                    <li class="upper-links dropdown"><a class="links"><?php echo e(\Auth::user()->nama); ?></a>
                    <ul class="dropdown-menu">
                        <li class="profile-li"><a class="profile-links" href="<?php echo e(route('logout')); ?>">Logout</a></li>
                    </ul>
                </li>
                <?php else: ?>
                <li class="upper-links"><a class="links" href="<?php echo e(route('login')); ?>">Login</a></li>
                <li class="upper-links dropdown"><a class="links" href="<?php echo e(route('register')); ?>">Daftar</a>
                    <!-- <ul class="dropdown-menu">
                        <li class="profile-li"><a class="profile-links" href="<?php echo e(route('register')); ?>">Menjadi Seller</a></li>
                        <li class="profile-li"><a class="profile-links" href="<?php echo e(route('register')); ?>">Menjadi Customer</a></li>
                    </ul> -->
                </li>
                <?php endif; ?>
            </ul>
...
<div style="background: #76b852"id="flipkart-navbar">
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right">
                <li class="upper-links"><a class="links" href="<?php echo e(route('tokosaya')); ?>">About</a></li>
                <li class="upper-links"><a class="links" href="https://campusbox.org/">Tempat Cetak</a></li>
                <li class="upper-links"><a class="links" href="<?php echo e(route('login')); ?>">Cetak Dokumen</a></li>
                <?php if((session()->has('login'))): ?>
                <li class="upper-links">
                    <a class="links" href="http://clashhacks.in/">
                        <svg class="" width="16px" height="12px" style="overflow: visible;">
