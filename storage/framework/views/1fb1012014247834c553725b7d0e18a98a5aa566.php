...
<!-- layanan print -->
<div class="col-md-6">
  <form class="form-horizontal" action="<?php echo e(route('tambahlayanan')); ?>" method="post">
...
<div class="form-group" style="margin-right: 0px;">
  ...
  <input class="form-control" name="id" value="<?php echo e($value->id); ?>" type="hidden">
...
<form class="form-horizontal" action="<?php echo e(route('tambahlayananjilid')); ?>" method="post">
  <?php echo e(csrf_field()); ?>
