            ...
            <div class="container">
                <div class="d-flex">
                    <a class="header-brand" href="{{ route('home')}}">
                        <img src="/img/logo.png" class="header-brand-img" alt="tabler logo">
                    </a>
                    ...
                    <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            ...
                            <li class="nav-item dropdown">
                                <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown" aria-expanded="false"><i
                                        class="fe fe-users"></i> Users</a>
        ...
        <div class="container">
                    ...
                    <li class="upper-links">
                        <a class="links" href="http://clashhacks.in/">
                            <svg class="" width="16px" height="12px" style="overflow: visible;">
                                <path d="M8.037 17.546c1.487 0 2.417-.93 2.417-2.417H5.62c0 1.486.93 2.415 2.417 2.415m5.315-6.463v-2.97h-.005c-.044-3.266-1.67-5.46-4.337-5.98v-.81C9.01.622 8.436.05 7.735.05 7.033.05 6.46.624 6.46 1.325v.808c-2.667.52-4.294 2.716-4.338 5.98h-.005v2.972l-1.843 1.42v1.376h14.92v-1.375l-1.842-1.42z"
                                    fill="#fff"></path>
                            </svg>Notifikasi
                        </a>
                    </li>
                    <li class="upper-links"><a class="links" href="http://clashhacks.in/">Pesanan Saya</a></li>
                    <li class="upper-links dropdown"><a class="links">{{\Auth::user()->name}}</a>
                        <ul class="dropdown-menu">
                            <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                @csrf
                            </form>
                            <li class="profile-li"><a class="profile-links" href="{{ route('logout') }}" onclick="event.preventDefault();
            ...
            <div class="row row2">
                ...
                <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                    <div class="row">
                        <input style="color:black" class="flipkart-navbar-input col-xs-11" type="text" placeholder="Search for Products, Brands and more"
                            name="search">
